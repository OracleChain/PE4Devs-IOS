...
- (UIView *)line1{
    if (!_line1) {
        ...
        _line1.backgroundColor = HEXCOLOR(0x999999);
    }
    return _line1;
}
...
- (UIView *)line2{
    if (!_line2) {
        ...
        _line2.backgroundColor = HEXCOLOR(0x999999);
    }
    return _line2;
}
...
- (UIView *)line3{
    if (!_line3) {
        ...
        _line3.backgroundColor = HEXCOLOR(0x999999);
    }
    return _line3;
}
...
- (UIView *)line4{
    if (!_line4) {
        ...
        _line4.backgroundColor = HEXCOLOR(0x999999);
    }
    return _line4;
}
